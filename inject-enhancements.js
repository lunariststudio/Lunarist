...
const requiredScripts=['lunarist-enhancements.js','social-links.js','member-social-fix.js','client-messaging.js','client-chat-and-artist-join.js','x-project-player.js'];
...
console.log('Lunarist profile/social/messaging/X-player scripts injected safely.');
