...
const requiredScripts=['lunarist-enhancements.js','social-links.js','member-social-fix.js','client-messaging.js','client-chat-and-artist-join.js','x-project-player.js','social-project-fix.js','services-drag-drop.js','x-discovery-likes.js','project-media-manager.js','slides-addon-logic.js','slides-addon-logic-fix.js'];
...
console.log('Lunarist enhancements injected: social players, messaging, metrics, draggable Services, Project Media multi-upload/carousel, and Slides as an Add-on; standalone Project Slides scripts remain removed.');
