...
const requiredScripts=['lunarist-enhancements.js','profile-social-settings.js','public-profile-socials.js','client-messaging.js','client-chat-and-artist-join.js','x-project-player.js','social-project-fix.js','services-drag-drop.js','x-discovery-likes.js','project-media-manager.js','slides-addon-logic.js','slides-addon-logic-fix.js'];
if(!html.includes('</body>'))throw new Error('index.html has no closing body tag');
const removedScripts=['slides-pricing.js','slides-live-ui.js','slides-persistence-fix.js','slides-hard-save.js','project-slides-view.js','slides-final-fix.js','project-media-carousel-fix.js','social-links.js','member-social-fix.js'];
...
console.log('Lunarist enhancements injected with native Profile Settings Social & Website and clickable public profile Social & Website; legacy social injectors removed.');
