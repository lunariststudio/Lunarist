...
const requiredScripts=['lunarist-enhancements.js','client-messaging.js','client-chat-and-artist-join.js','x-project-player.js','social-project-fix.js','services-drag-drop.js','x-discovery-likes.js','discover-role-filter.js','discover-filters-fix.js','project-media-manager.js','slides-addon-logic.js','slides-addon-logic-fix.js','profile-role-dropdown.js','eugene-lunarist-integration.js','eugene-connection-status-fix.js','eugene-status-render-fix.js'];
if(!html.includes('</body>'))throw new Error('index.html has no closing body tag');
const removedScripts=['slides-pricing.js','slides-live-ui.js','slides-persistence-fix.js','project-slides-view.js','slides-final-fix.js','project-media-carousel-fix.js','social-links.js','member-social-fix.js','profile-social-settings.js','public-profile-socials.js'];
...
console.log('Lunarist enhancements injected; Eugene Card reciprocal account-linking integration enabled.');
