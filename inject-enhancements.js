...
const requiredScripts=['lunarist-enhancements.js','social-links.js','member-social-fix.js','client-messaging.js','client-chat-and-artist-join.js','x-project-player.js','social-project-fix.js','slides-pricing.js','slides-live-ui.js'];
...
console.log('Lunarist enhancements injected: social players, messaging, X/Instagram metrics, visible Price/Slides, and multi-file Project Slides.');
