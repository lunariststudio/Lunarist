...
const requiredScripts=['lunarist-enhancements.js','client-messaging.js','client-chat-and-artist-join.js','x-project-player.js','social-project-fix.js','services-drag-drop.js','x-discovery-likes.js','discover-role-filter.js','discover-filters-fix.js','project-media-manager.js','slides-addon-logic.js','slides-addon-logic-fix.js','profile-role-dropdown.js','eugene-lunarist-integration.js','profile-eugene-card-tab.js','eugene-connection-status-fix.js','eugene-status-render-fix.js','eugene-card-oauth-ui.js','oauth-admin-ui.js?v=3','eugene-card-api-application-ui.js','oauth-browser-bridge.js'];
