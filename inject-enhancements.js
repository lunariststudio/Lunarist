...
const requiredScripts=['lunarist-enhancements.js','client-messaging.js','client-chat-and-artist-join.js','x-project-player.js','social-project-fix.js','services-drag-drop.js','x-discovery-likes.js','discover-role-filter.js','discover-filters-fix.js','project-media-manager.js','slides-addon-logic.js','slides-addon-logic-fix.js','profile-role-dropdown.js'];
...
console.log('Lunarist enhancements injected; Discover guild filter + search focus fix enabled; Profile Role dropdown enabled; Social & Website features remain removed.');
