...
const requiredScripts=['lunarist-enhancements.js','social-links.js','client-messaging.js'];
...
console.log('Lunarist enhancements, social links, and client messaging injected safely.');
