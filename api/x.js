...
export default async function handler(req,res){
  try{
    ...
    // Request variants field to retrieve direct video URLs
    ...
    // Extract the highest-bitrate MP4 URL from media.variants
    let directVideoUrl = '';
    ...
    return res.status(200).json({
      ...
      mediaUrl: directVideoUrl || media.url || '',
      mediaType: directVideoUrl ? 'video' : (media.type || ''),
