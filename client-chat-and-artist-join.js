  ...
  async function renderConversation(){
    ...
    root.querySelector('#lcc-compose').onsubmit=async e=>{
      ...
      try{
        ...
        try{await s.from('notifications').insert({user_id:a.id,title:'New Message',message:'A client sent you a message',type:'message',link:`chat:${c.id}`})}catch(e){console.warn('[Lunarist] notification insert failed (non-fatal):',e?.message||e)}
